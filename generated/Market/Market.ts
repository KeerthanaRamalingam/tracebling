...
export class ReserveAuctionSellerMigrated extends ethereum.Event {
  get params(): ReserveAuctionSellerMigrated__Params {
    return new ReserveAuctionSellerMigrated__Params(this);
  }
}

export class ReserveAuctionSellerMigrated__Params {
  _event: ReserveAuctionSellerMigrated;

  constructor(event: ReserveAuctionSellerMigrated) {
    this._event = event;
  }
  ...
  get originalSellerAddress(): Address {
    return this._event.parameters[1].value.toAddress();
  }

  get newSellerAddress(): Address {
    return this._event.parameters[2].value.toAddress();
  }
}
...
export class Market__getFeeConfigResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Market__getFeesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Market__getReserveAuctionResultValue0Struct extends ethereum.Tuple {
  get nftContract(): Address {
...
export class Market__getReserveAuctionConfigResult {
  value0: BigInt;
  value1: BigInt;
...
export class Market extends ethereum.SmartContract {
  ...
  getFeeConfig(): Market__getFeeConfigResult {
    ...
    return new Market__getFeeConfigResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getFeeConfig(): ethereum.CallResult<Market__getFeeConfigResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Market__getFeeConfigResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getFees(
    ...
    return new Market__getFeesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getFees(
    ...
    tokenId: BigInt,
    price: BigInt
  ): ethereum.CallResult<Market__getFeesResult> {
    let result = super.tryCall(
      "getFees",
      "getFees(address,uint256,uint256):(uint256,uint256,uint256)",
      [
  ...
  getReserveAuction(
    ...
    return result[0].toTuple() as Market__getReserveAuctionResultValue0Struct;
  }
  ...
  try_getReserveAuction(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as Market__getReserveAuctionResultValue0Struct
    );
  }

  getReserveAuctionConfig(): Market__getReserveAuctionConfigResult {
    let result = super.call(
    ...
    return new Market__getReserveAuctionConfigResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getReserveAuctionConfig(): ethereum.CallResult<
    Market__getReserveAuctionConfigResult
  > {
    let result = super.tryCall(
      "getReserveAuctionConfig",
      "getReserveAuctionConfig():(uint256,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Market__getReserveAuctionConfigResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
...
export class AdminAccountMigrationCall__Inputs {
  ...
  get listedAuctionIds(): Array<BigInt> {
...
export class AdminAddTokenCall extends ethereum.Call {
  get inputs(): AdminAddTokenCall__Inputs {
    return new AdminAddTokenCall__Inputs(this);
  }

  get outputs(): AdminAddTokenCall__Outputs {
    return new AdminAddTokenCall__Outputs(this);
  }
}

export class AdminAddTokenCall__Inputs {
  _call: AdminAddTokenCall;

  constructor(call: AdminAddTokenCall) {
    this._call = call;
  }
...
export class AdminAddTokenCall__Outputs {
  _call: AdminAddTokenCall;
